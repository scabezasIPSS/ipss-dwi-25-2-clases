...
<body>
    ...
    <div id="desarrolladores" class="container my-5 anchor-offset">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card bg-dark text-white h-100">
                    <img src="https://via.placeholder.com/150" class="card-img-top" alt="Foto de desarrollador">
                    <div class="card-body text-center">
                        <h5 class="card-title">Nombre del Desarrollador</h5>
                        <p class="card-text">Función: <span class="text-primary">Mantenedor</span></p>
                        <a href="#" class="btn btn-primary mt-2">Contacto</a>
                    </div>
                </div>
            </div>
        </div>
